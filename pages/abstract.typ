...
This bachelor's thesis was commissioned by SP-Timing. The objective was to create a system capable of timing participants in a race using a video-only solution. The timing accuracy had to be at least 1/10 second, the system had to be easy to deploy and as autonomous as possible.
